...
def __annotate_stream_snpeff(input_stream, output_stream, clinvar_fields=[], dbNSFP_fields=[], dbSNP_fields=[]):
...
def annotate_snpeff(input_file, out_file, clinvar_fields=[], dbNSFP_fields=[]):
    ...
    with open(out_file, "w") as output_stream:
        if is_gz_file(input_file):
            ...
            input_stream = p.stdout
        __annotate_stream_snpeff(input_stream, output_stream, clinvar_fields=clinvar_fields,
